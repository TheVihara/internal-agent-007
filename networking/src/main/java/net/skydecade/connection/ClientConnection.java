...
public class ClientConnection extends ChannelInboundHandlerAdapter {
    ...
    public ClientConnection(Channel channel, MasterServer server, PacketDecoder decoder, PacketEncoder encoder) {
        this.server = server;
    ...
    public void channelRead( ChannelHandlerContext ctx,  Object msg) {
        ...
        if (gameProfile.getUsername() != null) {
            PlayerInfo player = new PlayerInfo(gameProfile.getUsername(), "127.0.0.1", 25555);
            String selectedServer = server.getRandomProxyServer();
            server.redirectPlayer(player, selectedServer);
        }
    }
